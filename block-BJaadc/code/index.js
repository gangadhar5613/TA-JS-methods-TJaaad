...
console.log(`The length of ${message} is ${message.length}`);//The length of If you are still thinking the answer is no! is 43
...
console.log(`The last character of ${message} is ${message.charAt(message.length)}`);
...
console.log(message.includes("answers"));//false
